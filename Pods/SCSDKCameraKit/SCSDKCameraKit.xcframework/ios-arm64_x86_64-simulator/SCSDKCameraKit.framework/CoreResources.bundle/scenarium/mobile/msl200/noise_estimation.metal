...
{
return fract(sin(dot(uv,float2(12.9898,78.233)))*43758.5);
}
...
return float2(cos(6.28319*v),sin(6.28319*v))*sqrt((-2.0)*log(u));
}
...
noiseCol*=sqrt(1.0-fast::max(dot(srgbToLinear(param_9),float3(0.299,0.587,0.114)),0.0));
