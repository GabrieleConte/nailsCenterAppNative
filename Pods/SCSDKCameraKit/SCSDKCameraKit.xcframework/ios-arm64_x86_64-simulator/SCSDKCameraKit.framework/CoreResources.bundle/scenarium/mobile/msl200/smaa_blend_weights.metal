...
float2 SMAA_AREATEX_PIXEL_SIZE=float2(0.00625,0.00178571);
float SMAA_AREATEX_SUBTEX_SIZE=0.142857;
float4 smaaRTMetrics=float4(1.0/UserUniforms.inputTextureSize.x,1.0/UserUniforms.inputTextureSize.y,UserUniforms.inputTextureSize.x,UserUniforms.inputTextureSize.y);
...
float2 param_37=float2(step(float2(0.9),d.zw));
float2 param_38=cc;
...
float2 param_109=float2(step(float2(0.9),d.zw));
...
float2 param_12=e;
float param_13=0.0;
float offset=((-2.00787)*SMAASearchLength(param_12,param_13,UserUniforms,searchTex,searchTexSmpSC,sc_sysIn,sc_set0,sc_set1))+3.25;
