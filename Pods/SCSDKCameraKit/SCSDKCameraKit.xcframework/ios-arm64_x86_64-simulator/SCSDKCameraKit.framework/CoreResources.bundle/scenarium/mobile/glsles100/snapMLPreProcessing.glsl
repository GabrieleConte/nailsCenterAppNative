...
#if (USE_MIP_BIAS)
{
l9_3=sc_SampleView(screenTextureDims.xy,l9_1,screenTextureLayout,screenTextureGetStereoViewIndex(),screenTextureBias,screenTexture);
}
#else
{
l9_3=sc_SampleView(screenTextureDims.xy,l9_1,screenTextureLayout,screenTextureGetStereoViewIndex(),0.0,screenTexture);
}
#endif
vec4 l9_4;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_4=mix(screenTextureBorderColor,l9_3,vec4(l9_2));
}
#else
{
l9_4=l9_3;
