...
{
return texture2DLodEXT(texsmp,uv,level_);
}
#else
{
return vec4(0.0);
...
#if (sc_CanUseTextureLod)
{
return texture2DLodEXT(combinedSmp,uv,level_);
}
#else
{
return vec4(0.0);
...
#if (sc_CanUseTextureLod)
{
return texture2DArrayLodEXT(combinedSmp,uv,level_);
}
#else
{
return vec4(0.0);
...
#if (sc_CanUseTextureLod)
{
return texture3DLodEXT(combinedSmp,uv,level_);
}
#else
{
return vec4(0.0);
...
#if (sc_CanUseTextureLod)
{
return textureCubeLodEXT(combinedSmp,uv,level_);
}
#else
{
return vec4(0.0);
...
#if (sc_CanUseTextureLod)
{
return texture2DArrayLodEXT(texsmp,uv,level_);
}
#else
{
return vec4(0.0);
...
#if (sc_CanUseTextureLod)
{
return texture3DLodEXT(texsmp,uv,level_);
}
#else
{
return vec4(0.0);
...
#if (sc_CanUseTextureLod)
{
return textureCubeLodEXT(texsmp,uv,level_);
}
#else
{
return vec4(0.0);
...
return sc_InternalTextureLevel(texSize,uvi.xy,level,texsmp);
}
...
vec4 sc_SampleViewLevel(vec2 texSize,vec2 uv,int renderingLayout,int viewIndex,float level,highp sampler2DArray texsmp)
{
vec3 uvi=sc_SamplingCoordsViewToGlobal(uv,renderingLayout,viewIndex);
return sc_InternalTextureLevel(uvi,level,texsmp);
}
...
vec4 sc_SampleViewLevel(highp sampler2D combinedSmp,vec2 texSize,vec2 uv,int renderingLayout,int viewIndex,float level)
{
vec3 uvi=sc_SamplingCoordsViewToGlobal(uv,renderingLayout,viewIndex);
return sc_InternalTextureLevel(combinedSmp,texSize,uvi.xy,level);
}
...
vec4 sc_SampleViewLevel(highp sampler2DArray combinedSmp,vec2 texSize,vec2 uv,int renderingLayout,int viewIndex,float level)
{
vec3 uvi=sc_SamplingCoordsViewToGlobal(uv,renderingLayout,viewIndex);
return sc_InternalTextureLevel(combinedSmp,uvi,level);
}
...
sc_SoftwareWrapLate(uv.x,softwareWrapModes.x,useClampToBorderForWrap,clampToBorderFactor);
sc_SoftwareWrapLate(uv.y,softwareWrapModes.y,useClampToBorderForWrap,clampToBorderFactor);
vec4 tex=sc_SampleViewLevel(samplerDims,uv,renderingLayout,viewIndex,level,texture_sampler_);
if (useClampToBorder)
{
tex=mix(borderColor,tex,vec4(clampToBorderFactor));
}
...
vec4 sc_SampleTextureLevel(vec2 samplerDims,int renderingLayout,int viewIndex,vec2 uv,bool useUvTransform,mat3 uvTransform,ivec2 softwareWrapModes,bool useUvMinMax,vec4 uvMinMax,bool useClampToBorder,vec4 borderColor,float level,highp sampler2DArray texture_sampler_)
{
bool useClampToBorderForWrap=useClampToBorder&&(!useUvMinMax);
float clampToBorderFactor=1.0;
sc_SoftwareWrapEarly(uv.x,softwareWrapModes.x);
...
vec4 sc_SampleTextureBiasOrLevel(vec3 uv,bool shouldSampleLevel,float level,bool useUvTransform,mat3 uvTransform,highp sampler2DArray texsmp)
{
vec2 l9_0=sc_TransformUV(uv.xy,useUvTransform,uvTransform);
uv=vec3(l9_0.x,l9_0.y,uv.z);
vec4 l9_1=sc_InternalTextureLevel(uv,level,texsmp);
vec4 l9_2=l9_1;
return l9_1;
}
vec4 sc_SampleTextureBiasOrLevel(vec3 uv,bool shouldSampleLevel,float level,highp sampler3D texsmp)
{
vec4 l9_0=sc_InternalTextureLevel(uv,level,texsmp);
vec4 l9_1=l9_0;
return l9_0;
}
vec4 sc_SampleTextureBiasOrLevel(vec3 uv,bool shouldSampleLevel,float level,highp samplerCube texsmp)
{
vec4 l9_0=sc_InternalTextureLevel(uv,level,texsmp);
vec4 l9_1=l9_0;
return l9_0;
}
vec4 sc_SampleTextureBiasOrLevel(highp sampler2DArray combinedSmp,vec3 uv,bool shouldSampleLevel,float level,bool useUvTransform,mat3 uvTransform)
{
vec2 l9_0=sc_TransformUV(uv.xy,useUvTransform,uvTransform);
uv=vec3(l9_0.x,l9_0.y,uv.z);
vec4 l9_1=sc_InternalTextureLevel(combinedSmp,uv,level);
vec4 l9_2=l9_1;
return l9_1;
}
vec4 sc_SampleTextureBiasOrLevel(highp sampler3D combinedSmp,vec3 uv,bool shouldSampleLevel,float level)
{
vec4 l9_0=sc_InternalTextureLevel(combinedSmp,uv,level);
vec4 l9_1=l9_0;
return l9_0;
}
vec4 sc_SampleTextureBiasOrLevel(highp samplerCube combinedSmp,vec3 uv,bool shouldSampleLevel,float level)
{
vec4 l9_0=sc_InternalTextureLevel(combinedSmp,uv,level);
vec4 l9_1=l9_0;
return l9_0;
...
return texture2D(combinedSmp,uv,bias);
}
#else
{
return vec4(0.0);
...
{
float bias=sc_InternalCalculateSampleBias(texSize,uv,level_);
return texture2D(texsmp,uv,bias);
}
#else
{
return vec4(0.0);
...
{
l9_1=sc_InternalTextureLevel(uv,level,texsmp);
}
else
{
l9_1=sc_InternalTextureBiasOrLevel(uv,level,texsmp);
}
return l9_1;
}
vec4 sc_SampleTextureBiasOrLevel(vec3 uv,bool shouldSampleLevel,float level,highp sampler3D texsmp)
...
if (shouldSampleLevel)
{
l9_0=sc_InternalTextureLevel(uv,level,texsmp);
}
else
{
l9_0=sc_InternalTextureBiasOrLevel(uv,level,texsmp);
}
return l9_0;
}
vec4 sc_SampleTextureBiasOrLevel(vec3 uv,bool shouldSampleLevel,float level,highp samplerCube texsmp)
...
if (shouldSampleLevel)
{
l9_1=sc_InternalTextureLevel(combinedSmp,uv,level);
}
else
{
l9_1=sc_InternalTextureBiasOrLevel(combinedSmp,uv,level);
}
return l9_1;
}
vec4 sc_SampleTextureBiasOrLevel(highp sampler3D combinedSmp,vec3 uv,bool shouldSampleLevel,float level)
...
if (shouldSampleLevel)
{
l9_0=sc_InternalTextureLevel(combinedSmp,uv,level);
}
else
{
l9_0=sc_InternalTextureBiasOrLevel(combinedSmp,uv,level);
}
return l9_0;
}
vec4 sc_SampleTextureBiasOrLevel(highp samplerCube combinedSmp,vec3 uv,bool shouldSampleLevel,float level)
