...
//ubo float UserUniforms 2:4:424 {
...
bool param_11=(int(SC_USE_UV_TRANSFORM_baseTex)!=0);
float3x3 param_12=(*sc_set2.UserUniforms).baseTexTransform;
...
cubeCoord=fast::clamp(cubeCoord,float2(0.002),float2(0.998));
...
bool param_24=(int(SC_USE_UV_TRANSFORM_baseTex)!=0);
float3x3 param_25=(*sc_set2.UserUniforms).baseTexTransform;
