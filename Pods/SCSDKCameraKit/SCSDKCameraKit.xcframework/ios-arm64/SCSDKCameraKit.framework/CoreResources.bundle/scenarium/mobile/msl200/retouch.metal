...
//ubo float UserUniforms 2:4:276 {
...
{
return float4(0.299,0.587,0.114,0.0)*color;
}
...
float4 curr=getWeight(param_6,param_7,UserUniforms)*0.367879;
...
float4 lookup=((orgColor.yyxx*0.123047)+(row_col*0.125))+float4(0.000976562);
...
float3 lookup_1=((orgColor.xxy*float3(0.0585938,0.0585938,0.9375))+float3(mulB*0.0625,0.0))+float3(0.00195312,0.00195312,0.03125);
