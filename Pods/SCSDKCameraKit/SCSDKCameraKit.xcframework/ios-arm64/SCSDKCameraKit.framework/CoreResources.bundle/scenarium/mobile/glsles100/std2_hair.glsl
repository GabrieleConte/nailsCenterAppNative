...
vec3 pointWorldPosition=sc_StrandDataMapTextureSampleView(uv).xyz;
vec3 l9_0;
if (pointIsNotLast)
{
l9_0=sc_StrandDataMapTextureSampleView(uv+uvOffsetX).xyz;
}
else
{
...
if (pointIsNotFirst)
{
l9_1=sc_StrandDataMapTextureSampleView(uv-uvOffsetX).xyz;
}
else
{
...
{
neighbourIndices.x=sc_StrandDataMapTextureSampleView(vec2(0.0,uv.y)).w;
neighbourIndices.y=sc_StrandDataMapTextureSampleView(vec2(uvOffsetX.x,uv.y)).w;
...
vec3 pointWorldPosition1=sc_StrandDataMapTextureSampleView(uv1).xyz;
...
if (pointIsNotLast)
{
vec3 pointWorldPositionNext1=sc_StrandDataMapTextureSampleView(uv1+uvOffsetX).xyz;
pointWorldPositionInterpolatedNext=mix(pointWorldPositionInterpolatedNext,pointWorldPositionNext1,vec3(lerpTerm1));
}
if (pointIsNotFirst)
{
vec3 pointWorldPositionPrevious1=sc_StrandDataMapTextureSampleView(uv1-uvOffsetX).xyz;
...
vec3 pointWorldPosition2=sc_StrandDataMapTextureSampleView(uv2).xyz;
...
if (pointIsNotLast)
{
vec3 pointWorldPositionNext2=sc_StrandDataMapTextureSampleView(uv2+uvOffsetX).xyz;
pointWorldPositionInterpolatedNext=mix(pointWorldPositionInterpolatedNext,pointWorldPositionNext2,vec3(lerpTerm2));
}
if (pointIsNotFirst)
{
vec3 pointWorldPositionPrevious2=sc_StrandDataMapTextureSampleView(uv2-uvOffsetX).xyz;
