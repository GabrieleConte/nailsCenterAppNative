...
vertex sc_VertOut main_vert(sc_VertIn sc_vertIn [[stage_in]],constant sc_Set0& sc_set0 [[buffer(0)]],constant sc_Set1& sc_set1 [[buffer(1)]],uint gl_VertexIndex [[vertex_id]],uint gl_InstanceIndex [[instance_id]])
{
sc_SysIn sc_sysIn;
...
v.texture0=((sc_vertIn.atbCoord2d.xy*0.5)+float2(0.5))+(sc_vertIn.atbCoord2d.zw*0.5);
sc_Vertex_t param=v;
...
float4 resultColor=sc_ScreenTextureSampleView(param,sc_fragIn.sc_sysIn,sc_set0,sc_set1);
float4 param_1=resultColor;
